...
Config.camera = {
    model = 'hs_hunt_camera',
    coords = vector3(207.88, -926.65, 30.70),
...
Config.ghosts = {
    ...
    { model = 'm24_1_prop_m41_ghost_cop_01a', coords = vector3(-125.0405, -1101.732, 30.1394) },
    { model = 'm24_1_prop_m41_ghost_dom_01a', coords = vector3(-1189.4, -924.4425, 6.634784) },
